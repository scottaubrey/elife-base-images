...
build-php: build-php-7.1 build-php-7.2 build-php-7.3 build-php-7.4 build-php-8.0 build-php-8.1 build-php-8.2 build-php-8.3
build-php-7.1:
...
test-php: test-php-7.1 test-php-7.2 test-php-7.3 test-php-7.4 test-php-8.0 test-php-8.1 test-php-8.2 test-php-8.3
test-php-7.1:
...
build-and-test-php: build-and-test-php-7.1 build-and-test-php-7.2 build-and-test-php-7.3 build-and-test-php-7.4 build-and-test-php-8.0 build-and-test-php-8.1  build-and-test-php-8.2  build-and-test-php-8.3
...
buildx-and-push-php: buildx-and-push-php-7.1 buildx-and-push-php-7.2 buildx-and-push-php-7.3 buildx-and-push-php-7.4 buildx-and-push-php-8.0 buildx-and-push-php-8.1 buildx-and-push-php-8.2 buildx-and-push-php-8.3
